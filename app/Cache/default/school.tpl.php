...
<div class="probootstrap-page-wrapper">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 probootstrap-top-quick-contact-info">
                    <?php
                        ...
                        foreach( $title as $a){
                            $_INDEX++;
                    ?>
                        <span><i class="<?php if(isset($a[0])){echo $a[0];}?>"></i><?php if(isset($a[1])){echo $a[1];}?></span>
                    <?php } ?>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="probootstrap-flex-block">
                        ...
                        <div class="probootstrap-image probootstrap-animate" style="background-image: url(/school/img/slider_3.jpg)">
    ...
    <section class="probootstrap-section probootstrap-section-colored probootstrap-bg probootstrap-custom-heading probootstrap-tab-section" style="background-image: url(/school/img/slider_2.jpg)">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="probootstrap-teacher text-center probootstrap-animate">
                        <figure class="media">
                            <img src="/school/img/person_1.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
                        </figure>
                        <div class="text">
                            <h3>Chris Worth</h3>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="probootstrap-teacher text-center probootstrap-animate">
                        <figure class="media">
                            <img src="/school/img/person_5.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
                        </figure>
                        <div class="text">
                            <h3>Janet Morris</h3>
                            <p>English Teacher</p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="probootstrap-teacher text-center probootstrap-animate">
                        <figure class="media">
                            <img src="/school/img/person_6.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
                        </figure>
                        <div class="text">
                            <h3>Linda Reyez</h3>
                            <p>Math Teacher</p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="probootstrap-teacher text-center probootstrap-animate">
                        <figure class="media">
                            <img src="/school/img/person_7.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
                        </figure>
                        <div class="text">
                            <h3>Jessa Sy</h3>
                            <p>Physics Teacher</p>
    ...
    <section class="probootstrap-section probootstrap-bg probootstrap-section-colored probootstrap-testimonial" style="background-image: url(/school/img/slider_4.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3 text-center section-heading probootstrap-animate">
                ...
                <div class="col-md-12 probootstrap-animate">
                    <div class="owl-carousel owl-carousel-testimony owl-carousel-fullwidth">
                        ...
                        <div class="item">
                            <div class="probootstrap-testimony-wrap text-center">
                                <figure>
                                    <img src="/school/img/person_2.jpg" alt="Free Bootstrap Template by ProBootstrap.com">
                                </figure>
                        ...
                        <div class="item">
                            <div class="probootstrap-testimony-wrap text-center">
                                <figure>
                                    <img src="/school/img/person_3.jpg" alt="Free Bootstrap Template by ProBootstrap.com">
                                </figure>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 text-left">
                        <p>&copy; 2017 ProBootstrap:Enlight. All Rights Reserved. Designed &amp; Developed with <i class="icon icon-heart"></i> by ProBootstrap.com. More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>
                    </div>
